...
function getEnvParams() {
    ...
    let envParams = [
        ...
        { param_name: 'GEMINI_MODEL', param_value: 'gemini-1.0-pro', label: 'LLM Model of gemini/ollama' },
        ...
        { param_name: 'LABEL06', param_value: '', label: 'Elasticsearch(Examin)'},
        { param_name: 'USE_ELASTICSEARCH', param_value: 'false', label: 'Use Elasticsearch' },
        { param_name: 'ELASTICSEARCH_PROTOCOL', param_value: 'http', label: 'Elasticsearch protocol http/https' },
        { param_name: 'ELASTICSEARCH_HOST', param_value: 'localhost', label: 'Elasticsearch host IP or URL' },
        { param_name: 'ELASTICSEARCH_PORT', param_value: '9200', label: 'Elasticsearch port' },
        { param_name: 'ELASTICSEARCH_INDEX', param_value: 'gemini_pad', label: 'Elasticsearch index name' },
